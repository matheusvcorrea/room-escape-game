var step_10 = function (game) {}

var reg =  {};
step_10.prototype = {
	create: function () {
		backgroundImage = this.add.sprite(this.game.world.centerX, this.game.world.centerY, 'bg_step_10');
		backgroundImage.anchor.setTo(0.5);
		backgroundImage.scale.setTo(0.6, 0.6);

		star = this.add.sprite(this.game.world.centerX-200, this.game.world.centerY+165, 'star');
		star.scale.setTo(0.8, 0.8);
		star.inputEnabled = true;
		star.events.onInputDown.add(this.starClick, this);

		cam = this.add.sprite(this.game.world.centerX-200, this.game.world.centerY+145, 'cam');
		cam.scale.setTo(0.6, 0.6);
		cam.inputEnabled = true;
		cam.input.enableDrag(true);
...
function step_createModals_10() {
	reg.modal.createModal({
		...
		itemsArr: [{
			...
			type: "text",
			content: "Uma Árvore Binária pode ter um número maior ou igual a 2 \nde filhos em seus nós.",
			fontSize: 18,
			color: "0x363636",
			offsetY: -50
		}, {
