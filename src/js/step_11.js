var step_11 = function (game) {}

var reg =  {};
step_11.prototype = {
	create: function () {
		backgroundImage = this.add.sprite(this.game.world.centerX, this.game.world.centerY, 'bg_step_11');
		backgroundImage.anchor.setTo(0.5);
		backgroundImage.scale.setTo(0.6, 0.6);

		star = this.add.sprite(this.game.world.centerX-215, this.game.world.centerY-15, 'star');
		star.scale.setTo(0.8, 0.8);
		star.inputEnabled = true;
		star.events.onInputDown.add(this.starClick, this);

		cel = this.add.sprite(this.game.world.centerX-215, this.game.world.centerY-50, 'cel');
		cel.scale.setTo(0.6, 0.6);
		cel.inputEnabled = true;
		cel.input.enableDrag(true);
...
function step_createModals_11() {
	reg.modal.createModal({
		...
		itemsArr: [{
			...
			type: "text",
			content: "Uma Árvore Binária de Busca tem todos \nfilhos direitos menores que o nó pai.",
			fontSize: 18,
			color: "0x363636",
			offsetY: -50
		}, {
