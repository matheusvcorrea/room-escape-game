var step_2 = function (game) {}

var reg =  {};
step_2.prototype = {
	create: function () {
		backgroundImage = this.add.sprite(this.game.world.centerX, this.game.world.centerY, 'bg_setp_2');
		backgroundImage.anchor.setTo(0.5);
		backgroundImage.scale.setTo(0.9, 1.0);

		star = this.add.sprite(this.game.world.centerX-290, this.game.world.centerY+150, 'star');
		star.scale.setTo(0.9, 0.9);
		star.inputEnabled = true;
		star.events.onInputDown.add(this.starClick, this);

		coffe_cup = this.add.sprite(this.game.world.centerX-300, this.game.world.centerY+75, 'paper');
...
function step_createModals_2() {
	reg.modal.createModal({
		...
		itemsArr: [{
			...
			type: "text",
			content: "A palavra 'if', é uma estrutura de tomada \nde decisão em muitas linguagens de programação.",
			fontSize: 18,
			color: "0x363636",
			offsetY: -50
		}, {
